...
This is a modified version of Original Power Gadget software customised
for use within Marquette University, Milwaukee
...
To run: 
> ./mu_power_gadget [-e [sampling_delay_ms ] optional] -d duration]
